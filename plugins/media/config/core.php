 ...
 * @see MediaHelper
 */
require_once dirname(dirname(__FILE__)) . DS . 'libs' . DS . 'mm' . DS . 'src' . DS . 'Mime/Type.php';
 ...
 */
require_once dirname(dirname(__FILE__)) . DS . 'libs' . DS . 'mm' . DS . 'src' . DS . 'Media/Process.php';
 ...
 * @see MetaBehavior
 */
require_once dirname(dirname(__FILE__)) . DS . 'libs' . DS . 'mm' . DS . 'src' . DS . 'Media/Info.php';
