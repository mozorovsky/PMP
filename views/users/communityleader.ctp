<h2><?php echo 'Kontakt na vedoucího společenství: '?></h2>
<?php 	echo $this->Session->flash(); ?>									
<?php 	echo $this->Form->create('Contact', array('url' =>  '/users/communityleader'));
		...
		echo $this->Form->input('spolecenstvi',  array( 'label' => 'Společenství: <span class="form-required" title="'.__('This field is required.',TRUE).'">*</span>', 
			'class' => 'form-text',
			'size' => '60',	
			'after'	=> '<div class="clear"></div>',		
			'div' => array(
		...
		echo $this->Form->input('web',  array( 'label' => 'Web společenství:', 
			'class' => 'form-text',
			'size' => '60',	
			'after'	=> '<div class="clear"></div>',		
			'div' => array(
