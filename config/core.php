 ...
 * 'Session.save' must be set to 'database' in order to utilize this constant.
 */
	Configure::write('Session.database', 'shared');
 ...
 */
	Configure::write('Security.salt', 'DYhG93bFFFFFIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '7685930999993542496749683645');
 ...
 */
	...
	Configure::write('Config.language', 'cze');
	Configure::write('Config.country', 'czech-republic');
	Configure::write('Config.countrylabel', 'Czech republic');
	Configure::write('Config.currency', 'CZK');
	Configure::write('Config.tocurrency', 'EUR');
