	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Zobrazit _MENU_",
				"sZeroRecords": "Nic nenalezeno",
				"sEmptyTable": "Žádná data",
				"sLoadingRecords": "Nahrávám...",
				"sInfo": "_START_ až _END_ z _TOTAL_ položek",
				"sInfoEmpty": "0 až 0 z 0 položek",
				"sInfoFiltered": "(celkem _MAX_ položek)",
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "Vyhledávání:",
				"sUrl": "",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = '<label>Vyhledávání</label><input type="text"/>';
